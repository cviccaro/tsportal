/**
 * Original module: angular-directive-select-usstates.js by james huston
 * @link https://github.com/james-huston/angular-directive-select-usstate
 *
 * Added to tsportal module because the template was not working, and had to hardcode it as
 * template property.  In order to prevent doing this anytime this package would update, I've copied
 * it out and placed it here.
 *
 * ////////////////////
 * 
...
.directive('angSelectUsstates', function() {
  return {
    restrict: 'E',
    template: '<select ng-options="state.abbreviation as state.name for state in states">'
