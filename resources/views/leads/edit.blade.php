                ...
                <div class="form-group">
                     ...
                     @if (isset($tradeshows))
                        @foreach ($tradeshows as $tradeshow)
                            @if ($lead->tradeshow_id == $tradeshow->id)
                                <option value="{{$tradeshow->id}}" selected>{{$tradeshow->name}}</option>
                            @else
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" name="department" class="form-control" value="{{$lead->department}}"/>
                </div>
                    <div class="form-group">
                     <label for="event_type">Event Type</label>
                     <input type="text" name="event_type" class="form-control" value="{{$lead->event_type}}"/>
                </div>
                    <div class="form-group">
                     <label for="purpose_of_visit">Purpose of Visit</label>
                     <input type="text" name="purpose_of_visit" class="form-control" value="{{$lead->purpose_of_visit}}"/>
                </div>
                    <div class="form-group">
                     <label for="date_next_appointment">Date of Next Appointment</label>
                     <input type="text" name="date_next_appointment" class="form-control" value="{{$lead->date_next_appointment}}"/>
                </div>
                    <div class="form-group">
                     <label for="representative_name">Representative Name</label>
                     <input type="text" name="representative_name" class="form-control" value="{{$lead->representative_name}}"/>
                </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" name="phone_number" class="form-control" value="{{$lead->phone_number}}"/>
                </div>
                    <div class="form-group">
                     <label for="email_address">Email Address</label>
                     <input type="text" name="email_address" class="form-control" value="{{$lead->email_address}}"/>
                </div>
                    <div class="form-group">
                     <label for="address1">Address 1</label>
                     <input type="text" name="address1" class="form-control" value="{{$lead->address1}}"/>
                </div>
                    <div class="form-group">
                     <label for="address2">Address 2</label>
                     <input type="text" name="address2" class="form-control" value="{{$lead->address2}}"/>
                </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     @if ($lead->existing_customer == 1)
                        <input type="checkbox" name="existing_customer" class="form-control" checked />
                     @else
                         <input type="checkbox" name="existing_customer" class="form-control" />
                     @endif
                </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" name="udid" class="form-control" value="{{$lead->udid}}"/>
                </div>
                    <div class="form-group">
                     <label for="timestamp">Timestamp</label>
                     <input type="text" name="timestamp" class="form-control" value="{{$lead->timestamp}}"/>
                </div>
                    <div class="form-group">
                     <label for="modified">Modified</label>
                     <input type="text" name="modified" class="form-control" value="{{$lead->modified}}"/>
                </div>
